...
const __pdf = join(__dirname, 'pdf_parse_example_not_detecting_space_properly.pdf');
const __pdf_txt = join(__dirname, 'pdf_parse_example_not_detecting_space_properly.txt');
