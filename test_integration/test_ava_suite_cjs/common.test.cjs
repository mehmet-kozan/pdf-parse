...
test('ava framework test - dummy-test.pdf', async (t) => {
	const data = fs.readFileSync(path.join(__dirname, '../pdf_files/dummy-test.pdf'));
...
test('ava framework test - image-test.pdf - ss', async (t) => {
	const data = fs.readFileSync(path.join(__dirname, '../pdf_files/image-test.pdf'));
...
test('ava framework test - full-test.pdf', async (t) => {
	const data = fs.readFileSync(path.join(__dirname, '../pdf_files/full-test.pdf'));
